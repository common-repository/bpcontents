...
<div id="content">
	...
	<div id="oci-category-tree">
		<h2><?php _e('Member Categories', 'bpcontents') ?></h2>
		<?php oci_the_member_category_checklist('current=0') ?>
	</div>
	<p class="submit"><input type="submit" name="submit_delete_member_categories" id="submit" value="<?php _e( 'Delete', 'bpcontents' ) ?>" /></p>
	...
	<p>
		...
		<label><?php _e( 'Add member categories', 'bpcontents' ) ?></label>
		<input type="text" name="oci_new_member_categories" id="oci_new_member_categories" value="" />
	</div>
	<p class="submit"><input type="submit" name="submit_add_member_categories" id="submit" value="<?php _e( 'Add', 'bpcontents' ) ?>" /></p>
